...
background.src = "Images/graph.jpg"; 
...
background.onload = function () {
    ...
    for (var i = 0; i < 5; i++) {
        ...
        for (var j = 0; j < 5; j++) {
            ...
            td.style = 'border: 10px solid #ff6a00; margin-left: auto; margin-right: auto; font-size:42px;text-align: center;';
            

            td.innerHTML = (i * 5 + j + 1);
            td.onclick = function () {

                ChooseLevel(this.innerHTML);
            };
...
function ChooseLevel(levelNum) {
    ...
    outLevelDiv.style.visibility = "visible";
